    ...
    >
      ...
      <div className="relative z-10 w-[120px] flex-shrink-0 flex flex-col items-center justify-center gap-3 p-4 border-r border-white/10">
        <div className="text-center">
          <p className="tracking-widest uppercase" style={{ color: data.colors.accent, fontSize: 7 + _d }}>
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center gap-3 p-5 pr-6">
        <div>
          <h2 className="font-bold leading-tight text-white" style={{ fontSize: 20 + _d }}>{data.title}</h2>
          <p className="mt-0.5" style={{ color: data.colors.accent, fontSize: 11 + _d }}>{data.subtitle}</p>
        </div>
