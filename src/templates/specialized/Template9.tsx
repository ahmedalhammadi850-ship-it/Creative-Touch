    ...
    <div id="template-preview" style={{
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ color: colors.accent, fontSize: `${6 + _d}px`, letterSpacing: '0.2em', marginBottom: '6px', fontWeight: 700 }}>خدماتنا</div>
          <div style={{ color: '#fff', fontSize: `${15 + _d}px`, fontWeight: 900, lineHeight: 1.3, marginBottom: '7px' }}>{title}</div>
          <div style={{ width: '28px', height: '2px', background: colors.accent, borderRadius: '1px', marginBottom: '7px' }} />
          <div style={{ color: 'rgba(255,255,255,0.78)', fontSize: `${9 + _d}px`, lineHeight: 1.6 }}>{subtitle}</div>
        </div>
        {phone && (
          <div style={{ position: 'relative', zIndex: 1 }}>
            <div style={{ color: colors.accent, fontSize: `${7 + _d}px`, fontWeight: 700, marginBottom: '2px' }}>اتصل بنا</div>
            <div style={{ color: '#fff', fontSize: `${9 + _d}px`, fontWeight: 700 }} dir="ltr">{phone}</div>
          </div>
        )}
      </div>

      <div style={{ flex: 1, padding: '20px 16px', display: 'flex', flexDirection: 'column', gap: '7px' }}>
        <div style={{ color: colors.primary, fontSize: `${8 + _d}px`, letterSpacing: '0.15em', fontWeight: 700, marginBottom: '4px' }}>قائمة الخدمات</div>
