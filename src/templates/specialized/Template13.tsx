    ...
    <div id="template-preview" style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          fontSize: 9 + _d, fontWeight: 900, letterSpacing: '0.1em',
          padding: '3px 12px', borderRadius: 20, marginBottom: 10,
        }}>
          📚 التسجيل مفتوح الآن
        </div>
        <h1 style={{ color: '#fff', fontSize: 22 + _d, fontWeight: 900, margin: '0 0 4px', lineHeight: 1.3 }}>{title}</h1>
        <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: 12 + _d, margin: 0, fontWeight: 600 }}>{subtitle}</p>
      </div>
      ...
      <div style={{
        ...
        {image
          ...
          : <span style={{ fontSize: 30 + _d }}>🏫</span>}
      </div>

      {/* Content */}
      <div style={{ flex: 1, padding: '14px 18px 0 18px', marginTop: 10 }}>
        {/* Grades */}
        <p style={{ color: colors.primary, fontSize: 11 + _d, fontWeight: 800, marginBottom: 8 }}>المراحل الدراسية المتاحة:</p>
        ...
        <div style={{
          ...
          <p style={{ color: colors.secondary, fontSize: 11 + _d, fontWeight: 700, margin: '0 0 5px' }}>
            🎯 لا تفوّت فرصة التسجيل!
          </p>
          <p style={{ color: '#555', fontSize: 10.5 + _d, lineHeight: 1.7, margin: 0 }}>
