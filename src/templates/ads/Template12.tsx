  ...
  return (
    <div id="template-preview" style={{
      ...
      <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', padding: '0 30px' }}>
        <div style={{ color: data.colors.accent, fontSize: `${8 + _d}px`, letterSpacing: '0.28em', fontWeight: 700, marginBottom: '10px', textShadow: `0 0 12px ${data.colors.accent}` }}>
          ✦ عرض خاص ✦
        </div>
        <div style={{ color: data.colors.secondary, fontSize: `${30 + _d}px`, fontWeight: 900, lineHeight: 1.15, marginBottom: '6px', textShadow: `0 0 30px ${data.colors.primary}` }}>
          {data.title}
        </div>
        ...
        <div style={{ color: data.colors.secondary, fontSize: `${11 + _d}px`, fontWeight: 600, marginBottom: '10px', opacity: 0.85 }}>{data.subtitle}</div>
        <div style={{ color: `${data.colors.secondary}99`, fontSize: `${10 + _d}px`, lineHeight: 1.75, marginBottom: '20px' }}>{data.description}</div>
        {data.phone && (
          <div style={{
            ...
            <span style={{ color: data.colors.accent, fontSize: `${12 + _d}px`, fontWeight: 800, textShadow: `0 0 10px ${data.colors.accent}`, whiteSpace: 'nowrap' }} dir="ltr">{data.phone}</span>
          </div>
        )}
      </div>
    </div>
