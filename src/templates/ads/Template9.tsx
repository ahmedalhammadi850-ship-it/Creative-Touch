    ...
    <div id="template-preview" style={{
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ color: 'rgba(255,255,255,0.78)', fontSize: `${9 + _d}px`, letterSpacing: '0.15em', marginBottom: '5px' }}>عرض حصري</div>
          <div style={{ color: '#fff', fontSize: `${21 + _d}px`, fontWeight: 900, lineHeight: 1.2 }}>{data.title}</div>
          <div style={{ color: data.colors.accent, fontSize: `${12 + _d}px`, fontWeight: 700, marginTop: '4px' }}>{data.subtitle}</div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, padding: '12px 22px' }}>
        ...
        {data.phone && (
          <div style={{
            ...
            <div style={{ color: data.colors.primary, fontSize: `${9 + _d}px`, fontWeight: 700, marginBottom: '2px' }}>تواصل معنا</div>
            <div style={{ color: data.colors.secondary, fontSize: `${13 + _d}px`, fontWeight: 800 }} dir="ltr">{data.phone}</div>
          </div>
        )}
      </div>
    </div>
