  ...
  return (
    ...
    >
      ...
      <div className="z-10 flex flex-col items-center gap-1 pt-2">
        <div className="text-[9px] tracking-[0.3em] uppercase" style={{ color: data.colors.accent }}>Wedding Invitation</div>
        <div className="w-16 h-px mt-1" style={{ backgroundColor: data.colors.accent }} />
      </div>

      <div className="z-10 flex flex-col items-center gap-3">
        <h2 className="text-4xl font-serif" style={{ color: data.colors.primary }}>{data.title}</h2>
        <div className="text-2xl font-serif italic" style={{ color: data.colors.accent }}>✦ & ✦</div>
        <h2 className="text-4xl font-serif" style={{ color: data.colors.primary }}>{data.subtitle}</h2>
      </div>
