    ...
    <div dir="rtl" style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#f8f7ff 0%,#eef2ff 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px 16px', fontFamily: "'Cairo',sans-serif", boxSizing: 'border-box' }}>
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <h1 style={{ color: '#1e1b4b', fontSize: 24, fontWeight: 900, margin: '0 0 6px' }}>استعادة كلمة المرور</h1>
          <p style={{ color: '#64748b', fontSize: 14, margin: 0 }}>سنرسل لك رابط إعادة التعيين على بريدك</p>
        </div>
        ...
        <div style={{ background: '#fff', borderRadius: 20, padding: 'clamp(20px,5vw,36px) clamp(16px,5vw,32px)', boxShadow: '0 8px 40px rgba(99,102,241,0.12)', border: '1px solid rgba(99,102,241,0.1)' }}>
          ...
          {sent ? (
            <div style={{ textAlign: 'center', padding: '8px 0' }}>
              <div style={{ width: 72, height: 72, borderRadius: '50%', background: '#ecfdf5', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 18px' }}>
                <CheckCircle size={38} color="#10b981" />
              </div>
              <h3 style={{ color: '#1e1b4b', fontSize: 20, fontWeight: 900, marginBottom: 10 }}>تم إرسال الرابط!</h3>
              <p style={{ color: '#64748b', fontSize: 13, lineHeight: 1.8, marginBottom: 6 }}>أرسلنا رابط إعادة تعيين كلمة المرور إلى</p>
              <p style={{ color: '#6366f1', fontSize: 14, fontWeight: 800, marginBottom: 8, direction: 'ltr', wordBreak: 'break-all' }}>{email}</p>
              <p style={{ color: '#94a3b8', fontSize: 12, lineHeight: 1.8, marginBottom: 28 }}>
                افتح بريدك وانقر على الرابط لإعادة تعيين كلمة المرور.<br />
